...
export async function addProgressEntry(userId, input) {
...
export async function listProgressEntries(userId, opts) {
    const where = { userId };
    if (opts?.subject)
        where.subject = { contains: opts.subject, mode: 'insensitive' };
